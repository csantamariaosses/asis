    ...
    <div class="row">
        ...
        <div class="col-sm-6">
             <div class="well well-sm">
              ...
              <!--
              <form name="fmImage" id="frmImage" action="{{action('CatalogoController@adminCatalogoProveedorToProductosCargaImagen')}}" method="POST" enctype="multipart/form-data">
                 {{ csrf_field() }}
          ...
          <form name="fm" id="frm" action="{{route('catalogo-to-productos-guardar')}}" method="POST">
           ...
           <input type="hidden" name="image" value="{{$archImage}}">
            <input type="hidden" name="id" value="{{$id}}">
              ...
              <tr><th><td>Codigo</td></th><td><input type="text" name="idProducto" id="idProducto" value="{{$prod->idProducto}}" required><input type="button" value="Verif"></td></tr>
