        ...
        <div class="cols-sm-12">
          ...
          @if( count( $carritoCotizador) > 0 ) 
           ...
           <br>
               ...
               <table>
                 <tr><td>Nombre:</td><td><input type="text" name="nombre" size="40" value="{{ $carritoCotizador["nombre"]}}"></td></tr>
                 <tr><td>Atte.:</td><td><input type="text" name="atte" size="40" value="{{ $carritoCotizador["contacto"]}}"></td></tr>
                 <tr><td>Direccion.:</td><td><input type="text" name="direccion" size="40" value="{{ $carritoCotizador["direccion"]}}"></td></tr>
               </table>
               <br>
                <br>
