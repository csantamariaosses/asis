    ...
    <div class="row">
        <div class="col-sm-12">
             <div class="well well-sm">
              ...
              <hr>
           <br>
               <form name="frmSaveInfoClie" action="{{route('admin-cotizaciones-saveInfoClieNew')}}" method="POST">  
                   {{ csrf_field() }}
                   
               <table>
                <tr><td>Rut::</td><td><input type="text" name="rut" id="rut" size="60" value="{{$infoCabecera['rut']}}" onkeyup="formatoRut()" maxlength="10"></td></tr>
