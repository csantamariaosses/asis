...
<div class="container">
     <div class="row">
         <div class="col-sm-12">
          <h3><i class="fa fa-shopping-cart"></i>  Cotizacion Interna Nueva</h3>
          <h4></h4>
         </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-12">
             <div class="well well-sm">
              ...
              <hr>
           <br>
               <form name="frmSaveInfoClie" action="{{route('admin-cotizacionesinternas-saveInfoClieNew')}}" method="POST">  
                   {{ csrf_field() }}
