            ...
            <div class="col-sm-12">
                <table class="table-bordered" width="100%">
                    ...
                    <tr>
                        ...
                        <td> 
                            <button type="button" class="btn btn-default" onClick="location.href='{{route('admin-carrito-pedidos-editar',[$registro->codigo])}}'"><i class="fa fa-eye"></i>&nbsp;Modificar</button>
 
                            <button type="button" class="btn btn-default" onClick="location.href='{{route('admin-carrito-pedidos-descargar',[$registro->codigo])}}'"><i class="fa fa-download"></i>&nbsp;Descarga</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" hint="eliminar" onClick="location.href='{{ route('admin-carrito-pedidos-eliminar',[$registro->codigo])}}'">Eliminar</button>
