...
/*.page_break { page-break-after: always; } */
    ...
    <body>
        <img src="{{asset('storage/encabezadoPlantillaCotizaciones.jpg')}}" width="90%">
        <div align='center' style="background-color:#93b950"><span id="titulo">COTIZACION INTERNA</span></div> 
         <hr>
         <div id="datosCliente">
           <table id="infoCliente">
             <tr><td><b>Nro</b></td><td>:<b>{{$infoCabeceraCotizInterna['codigo']}}</b></td></tr>
             <tr><td><b>Usuario</b></td><td>:{{$infoCabeceraCotizInterna['usuario']}}</td></tr>
             <tr><td><b>Nombre</b></td><td>:{{$infoCabeceraCotizInterna['nombre']}}</td></tr>
             <tr><td><b>Fecha</b></td><td>:{{ date("d-m-Y")}}</td></tr>  
             <tr><td><b>Observaciones</b></td><td>:{{ $infoCabeceraCotizInterna['observaciones']}}</td></tr>  
            </table>
        </div>   
        <br>
        ...
        <hr>
          ...
          @if( count( $carritoCotizacionInterna) > 0 ) 
            <div>
               <table class="table-ligth table-bordered" width="100%">
               <tbody>
                   <tr>
                       <th width="5%">Nro.</th>
                   ...
                   <tr><td><b>Total</b></td><td></td><td></td><td align="right">{{$cantidad}}</td><td></td><td align="right"><b>${{number_format($total,0)}}</b></td></tr>
